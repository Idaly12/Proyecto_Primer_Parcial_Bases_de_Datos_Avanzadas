...
class AuthWindow(ctk.CTkToplevel):
    ...
    def handle_login(self):
        ...
        if user_data and password == user_data[3]:
            ...
            # Su propio `protocol("WM_DELETE_WINDOW", ...)` se encargará de cerrar la app.
            BlogApp(master=self.main_app_master, user_id=db_user_id)

        else:
            messagebox.showerror("Error", "Correo o contraseña incorrectos.")

    # --- El resto del archivo es idéntico al anterior y no necesita cambios ---
